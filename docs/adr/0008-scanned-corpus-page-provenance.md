...
> **Superseded by [ADR 0010](0010-graphrag-lightrag-corpus.md)** (2026-08-28). Its two load-bearing principles — printed page numbers are the citation authority, and only checkable things may be cited — carry forward there verbatim; everything else here describes the retired Chroma/JSONL path.
